...
import com.shatteredpixel.shatteredpixeldungeon.utils.state_management.State.StateReader;
...
public class DesktopLauncher {
	public static SpeechEventListenerDesktop speechEventListenerDesktop;

	public static void main (String[] args) {

		speechEventListenerDesktop = new SpeechEventListenerDesktop();
		StateReader.speechEventHandler.addStringChangeListener(speechEventListenerDesktop.listener);
